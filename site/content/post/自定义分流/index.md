---
title: 自定义分流
date: 2025-12-15T15:05:13.204Z
description: 如果内置的 geo(-ip、-site)和ACL规则还不能满足你的需求，那么可以尝试 自定义分流组 和 自定义代理组/自定义自动选择
---
物料
...
Domain Suffix 处填入 "translate.brave.com", 注意:不要有DEMO:字符
